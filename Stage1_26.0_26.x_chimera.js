 ...
 * works correctly for iOS 26.x targets.
 *
 * To implement:
 *   1. Identify a WebKit/JSC vulnerability for iOS 26.x
...
r.si = async function () {
  ...
  window.log("[STAGE1-CHIMERA] iOS 26.x exploit — version " + version);
  window.log("[STAGE1-CHIMERA] STUB: exploit primitives not yet implemented");
  throw new Error("Stage1 chimera: not implemented for iOS 26.x");
};
